...
INSERT INTO USER(ID, EMAIL, FIRST_NAME, LAST_NAME, PASSWORD, TEAM_ID,STATUS) VALUES
  (1, 'admin@email.com', 'admin', 'admin', '$2a$11$qwDZtD8OSyaQ5aeL.leCoOycbRTy6rO.9FFLxFFOQ2cFtL/ZZkNw.', NULL,TRUE );
